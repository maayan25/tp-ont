...
PYTHON_SCRIPT="PDDLKGConstructor.py"
...
# Domains with issues:
# 1998.grid-round-2-strips
# 1998.gripper-round-1-strips
# 1998.movie-round-1-strips
# 2000.freecell-strips-typed
# 2002.zenotravel-strips-automatic
# 2004.promela-dining-philosophers-stripscounters